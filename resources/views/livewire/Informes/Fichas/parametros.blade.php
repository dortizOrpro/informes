    ...
    <div class="grid grid-cols-12">
            ...
            <div class="p-2">
                <div class="flex gap-4 px-4 pt-2">
                    ...
                    <div class="flex-none w-3/4">
                        <x-select :options="$criterios" wire:model.live="criterio" class="w-full"></x-select>
                    </div>
                </div>
                ...
                <div class="flex gap-4 px-4 pt-2">
                    ...
                    <div class="flex-none w-3/4">
                        <x-file wire:model="excelCobranzas"></x-file>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-12">
            <div class="col-span-9  text-start" style="height: calc(100vh - 128px)">
                <livewire:informes.fichas.criterio 
                    :criterio="$criterio"
                    wire:key="criterio-{{ $criterio }}" 
                />
            </div>
        </div>
