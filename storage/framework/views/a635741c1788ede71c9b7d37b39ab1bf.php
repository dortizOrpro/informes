...
<?php $component = Src\Shared\UserInterface\Components\Header::resolve(['title' => 'Rendiciones','subtitle' => 'Recaudación'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('rendiciones.parametros', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3670664642-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\Users\diego.ortiz\Documents\GitHub\informes\resources\views/pages/rendicion/index.blade.php ENDPATH**/ ?>