...
<?php $component = Src\Shared\UserInterface\Components\Header::resolve(['title' => 'Informes','subtitle' => 'Fichas de cobranzas seleccionadas'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('informes.fichas.ficha', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3080032186-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH C:\Users\diego.ortiz\Documents\GitHub\informes\resources\views/pages/informes/fichas/inicio.blade.php ENDPATH**/ ?>