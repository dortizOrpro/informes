...
<?php $component = Src\Shared\UserInterface\Components\Header::resolve(['title' => 'Caja','subtitle' => 'Recaudación'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('calculo.parametros', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2204561148-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\Users\diego.ortiz\Documents\GitHub\informes\resources\views/pages/caja/index.blade.php ENDPATH**/ ?>