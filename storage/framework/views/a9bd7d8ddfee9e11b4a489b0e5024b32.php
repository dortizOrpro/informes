...
<?php $component = Src\Shared\UserInterface\Components\Header::resolve(['title' => 'Informes','subtitle' => 'Cronologias de clientes'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('informes.cronologias.cronologia', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1635081417-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?><?php /**PATH C:\Users\diego.ortiz\Documents\GitHub\informes\resources\views/pages/informes/cronologias/inicio.blade.php ENDPATH**/ ?>