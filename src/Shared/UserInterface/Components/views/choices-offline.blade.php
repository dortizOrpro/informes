    ...
    >
        ...
        <div x-cloak x-show="focused" class="relative" wire:key="options-list-main-{{ $uuid }}" >
            <div
                ...
                class="{{ $height }} w-full absolute z-10 bg-base-100 border border-base-content/10 rounded-lg cursor-pointer overflow-y-auto"
...
{{--                    class="p-3 decoration-wavy decoration-warning underline  border border-s-4 border-s-warning border-b-base-200"--}}
{{--                >--}}
{{--                    {{ $noResultText }}--}}
{{--                </div>--}}
