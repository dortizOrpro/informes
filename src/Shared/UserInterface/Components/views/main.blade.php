    ...
    <div @class([
        ...
        @if($sidebar)
            <div
                ...
                @class(["drawer-side z-20 lg:z-auto ", "top-0 lg:top-[49px] lg:h-[calc(100vh-49px)]" => $withNav])
            >
                ...
                <div
                    :class="collapsed
                                        ? '!w-[68px] [&>*_summary::after]:!hidden [&_.mary-hideable]:!hidden [&_.display-when-collapsed]:!block [&_.hidden-when-collapsed]:!hidden'
                    ...
                    {{
                        $sidebar->attributes->class([
                            ...
                            "w-[68px] [&>*_summary::after]:hidden [&_.mary-hideable]:hidden [&_.display-when-collapsed]:block [&_.hidden-when-collapsed]:hidden" => session('mary-sidebar-collapsed') == 'true',
