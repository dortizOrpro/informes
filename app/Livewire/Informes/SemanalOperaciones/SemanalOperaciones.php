...
namespace App\Livewire\Informes\SemanalOperaciones;

use Livewire\Component;
use Src\Procesos\Application\UseCases\GenerarSemanalOperacionesUseCase;

class SemanalOperaciones extends Component
{
    ...
    public function generar(GenerarSemanalOperacionesUseCase $uc)
    {
        if ($this->cliente == 0) {
            return;
        }
    ...
    {
        return view('livewire.informes.semanal-operaciones.parametros');
    }
}
